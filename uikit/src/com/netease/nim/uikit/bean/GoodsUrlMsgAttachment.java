 ...
 */
public class GoodsUrlMsgAttachment extends CustomAttachment implements Serializable {
    ...
    public GoodsUrlMsgAttachment() {
        super(CustomAttachmentType.TYPE_GOODS_URL);//消息类型
    }
