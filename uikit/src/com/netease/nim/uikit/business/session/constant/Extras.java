...
public interface Extras {
    ...
    //TODO 添加的参数
    String EXTRA_DISABLE_CAMERA = "disable_camera";
    String EXTRA_DISABLE_RECORD = "disable_record";
    String EXTRA_IS_FULL_SCREEN = "is_full_screen";
    String EXTRA_IS_MINI_MODE = "is_mini_mode";
    String EXTRA_GOODS_TIP_MSG = "goods_tip";//发送商品链接的提示消息
}
