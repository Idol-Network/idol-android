...
/**
 * Created by Allan_Zhang on 2018/3/19.
 */
...
public class TyperTextView extends AppCompatTextView {
     ...
     * 默认打字间隔时间
     */
    public static final int DEFAULT_TIME_DELAY = 100;
    /**
     * 计时器
     */
    ...
    private PrinterTimeTask mTimeTask;
     ...
     * @param str
     */
    public void setTyperText(String str) {
    ...
    public void startPrint() {
        ...
        printProgress = 0;
        mTimer = new Timer();
        mTimeTask = new PrinterTimeTask();
        mTimer.schedule(mTimeTask, intervalTime, intervalTime);
    }
